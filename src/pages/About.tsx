            ...
            <div className="md:flex md:items-center md:justify-between">
              ...
              <div className="md:w-1/2">
                <div className="relative h-64 md:h-80 rounded-2xl overflow-hidden shadow-xl">
                  <img alt="Team of mental health professionals collaborating" src="/lovable-uploads/05ce1b43-791b-4916-9792-7937bdaec6ad.jpg" className="w-full h-full object-fill" />
                </div>
              </div>
            </div>
          </div>
